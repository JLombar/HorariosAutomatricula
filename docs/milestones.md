...
* Definir el dominio del problema de la HU1 que será el principal foco de desarrollo. Para ello se incluirá un modelo inicial que será modificado y ampliado con el resto de historias de usuario en un futuro.
